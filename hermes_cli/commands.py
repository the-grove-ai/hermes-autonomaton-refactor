...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("tier", "Override or inspect Cognitive Router tier selection", "Configuration",
               cli_only=True, args_hint="[T1|T2|T3|reset]",
               subcommands=("T1", "T2", "T3", "reset")),
    CommandDef("register", "Show or switch the session's register overlay (standards / operator / editorial)",
               "Configuration", cli_only=True,
               args_hint="[name | list | reset]",
               subcommands=("list", "reset", "standards", "operator", "editorial")),
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.grove/skills/ for newly installed or removed skills",
    ...
    CommandDef("why", "Explain why the Cognitive Router chose the last turn's tier", "Info",
               cli_only=True),
