...
def _install_dependencies(provider_name: str) -> None:
    ...
    # Populated per user-installed provider whose pip name differs from
    # its import name; empty by default.
...
def cmd_setup(args) -> None:
    ...
    if not providers:
        ...
        print("  Install a plugin to ~/.grove/plugins/ and try again.\n")
        return
...
def cmd_status(args) -> None:
    ...
    if provider_name:
        ...
        if found:
            ...
            print(f"  Install the '{provider_name}' memory plugin to ~/.grove/plugins/")
