...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.grove/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.grove/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.grove/migration/openclaw/20250312T120000",
        }
