...
# NOTE (hermes-severance): four async tests that exercised the extract /
# crawl per-URL website-policy short-circuit through the firecrawl plugin
# were removed here when plugins/web/firecrawl was deleted:
...
# The generic check_website_access unit tests above remain. Re-establishing
# extract/crawl short-circuit coverage against the Tavily provider is a
# follow-up.
