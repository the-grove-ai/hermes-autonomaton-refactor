...
class TestCronDenyMode:
    """When GROVE_CRON_SESSION is set and cron_mode=deny, dangerous commands are blocked."""
...
class TestCronApproveMode:
    """When GROVE_CRON_SESSION is set and cron_mode=approve, dangerous commands pass through."""
...
class TestCronWithGatewayOrigin:
    ...
    cron/scheduler.py binds GROVE_SESSION_PLATFORM via contextvars for
