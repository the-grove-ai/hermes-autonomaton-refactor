...
class TestDispatcherHandlerInjection:
    ...
    def test_injected_handler_stored_on_dispatcher(self):
        ...
        assert d._sovereign_prompt_handler is non_interactive_deny_handler
    ...
    def test_separate_dispatchers_hold_distinct_handlers(self):
        ...
        deny_disp = Dispatcher(sovereign_prompt_handler=non_interactive_deny_handler)
        allow_disp = Dispatcher(sovereign_prompt_handler=silent_allow_handler)
        assert deny_disp is not allow_disp
        assert deny_disp._sovereign_prompt_handler is non_interactive_deny_handler
        assert allow_disp._sovereign_prompt_handler is silent_allow_handler
    ...
    def test_handler_threads_through_agent_kwargs_construction(self):
        ...
        assert d._sovereign_prompt_handler is non_interactive_deny_handler
        assert d.agent._sovereign_prompt_handler is non_interactive_deny_handler
        assert d.agent._dispatcher_singleton is d
