...
# ── Canonical curator (agent.curator) ────────────────────────────────────
# GRV-009 E7 — the dormant grove/kaizen/curator.py duplicate is deleted (it
# was unimported at runtime and broken post-C2-burn). Its duplication-guard
# tests (kaizen-curator importable / matches-agent-interface) are removed with
# it; agent.curator is the sole canonical implementation.
