...
Data file: $GROVE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_GROVE_HOME = Path(os.environ.get("GROVE_HOME", Path.home() / ".grove"))
DATA_DIR = _GROVE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
