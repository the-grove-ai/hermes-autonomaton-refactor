...
PROPOSAL_APPROVAL_GUIDANCE = (
    ...
    "reject_proposal(id).\n"
    "3. NEVER tell the operator to run a CLI command (e.g. `flywheel approve …`) "
    "and never show them a proposal id or SHA hash. Their natural-language reply "
    "IS the checkpoint — apply their decision inline and handle the mechanics "
    "invisibly.\n"
