...
PROPOSAL_APPROVAL_GUIDANCE = (
    ...
    "'skip', 'dismiss', 'reject', 'not that one'):\n"
    ...
    "by calling the tool WITH NO id: approve_proposal() to commit, or "
    "reject_proposal() to dismiss. With no id the tool targets the most recently "
    "surfaced proposal — you do NOT need to look up an id, and you must NOT call "
    "review_proposals or ask which one they mean.\n"
