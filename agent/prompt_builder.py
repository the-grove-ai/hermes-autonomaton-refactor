...
GROVE_AGENT_HELP_GUIDANCE = (
    ...
    "Writes to your own workspace (~/.grove/research/, ~/.grove/notes/, "
    "~/.grove/memory/, and other working directories under ~/.grove/) are "
    "within your authority — execute them directly with shell commands. Do not "
    "ask permission for workspace writes. Writes to governance configuration "
    "(zones schema, routing config, prompt config, skill activations, dock "
    "goals) are structural boundaries the governance system enforces.\n"
