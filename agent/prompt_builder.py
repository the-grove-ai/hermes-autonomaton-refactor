...
GROVE_AGENT_HELP_GUIDANCE = (
    ...
    "~/.grove/notes/ for writing; read access is broad — attempt the read, and "
    "the result tells you if a file is protected. Use the file tools "
...
SYSTEM_SELF_AWARENESS = (
    ...
    "\n"
    "Read access is broad — attempt any read you need. If a specific file is "
    "protected, the result will tell you why; don't pre-judge what you can "
    "read. Always attempt the action the operator requests; never predict "
