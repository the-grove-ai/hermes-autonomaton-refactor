...
class DockMutationDetector:
    ...
    def detect(
        ...
        4. T1 names a theme → one proposal; T1 declines → ``[]``; a T1
           FAILURE raises (detector-sweep-resilience-v1 R-2) — contained
           and filed by the Dispatcher's per-producer sweep guard.
        """
