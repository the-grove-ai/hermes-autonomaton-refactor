...
class AIAgent:
    ...
    def _run_turn_generator(
        ...
        * ``self._current_messages`` exposes the active messages list
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    if (
                        ...
                        from hermes_constants import display_hermes_home as _dhh_fn
                        _dhh = _dhh_fn()
                        print(f"{self.log_prefix}     • Check ANTHROPIC_TOKEN in {_dhh}/.env for Autonomaton-managed OAuth/setup tokens")
        ...
        # kaizen-offerings (Cut B) — surface ONE pending Flywheel offering at
        # this natural break (generalizes the Sprint 63 §3 synthesis quiet
