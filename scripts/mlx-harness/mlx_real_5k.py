#!/usr/bin/env python3
"""Measure MLX (mlx_lm.server, OpenAI endpoint) at the ~5K prefill (the Sprint 71 survived point)."""
...
for label, user in [("COLD ~5K: tool-trigger", "Compute 2 to the power of 20 by running code."),
