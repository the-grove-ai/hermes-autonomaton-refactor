...
Config: ~/.grove/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.grove/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (GROVE_HOME-aware and
