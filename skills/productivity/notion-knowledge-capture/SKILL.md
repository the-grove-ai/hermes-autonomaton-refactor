...
3. **Determine location**: Use `mcp_notion_notion_search` to find appropriate wiki page/database
4. **Create page**: Use `mcp_notion_notion_create_pages` to save content
