...
### 1. Find & Fetch Spec
```
mcp_notion_notion_search → Found "User Preferences Schema Migration Spec"
mcp_notion_notion_fetch → Extracted requirements
```
...
```
mcp_notion_notion_search → Found "Engineering Tasks" database
mcp_notion_notion_fetch → Got schema (Task, Status, Priority, Assignee, etc.)
