...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("GROVE_HOME", os.path.expanduser("~/.grove")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("GROVE_HOME", Path.home() / ".grove")) / "skills" / "red-teaming" / "godmode" / "scripts"
